(function () {
    ...
    restaurarCtrl.$inject = ['dataService', '$rootScope', 'toastr', '$uibModal', '$state', 'md5', '$auth','config'];

    function restaurarCtrl(dataService, $rootScope, toastr, $uibModal, $state, md5, $auth,config) {
